    ...
    <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_360px]">
      <section className="rounded border border-border bg-surface p-6">
        ...
        <p className="mt-2 text-sm leading-6 text-muted">
          Reserved for the prototype upload workspace. PDF upload and future Zotero connection options stay
          visible here, but no provider calls run in this phase.
        </p>
        <div className="mt-5 grid gap-3 sm:grid-cols-3">
          <Badge>PDF upload placeholder</Badge>
          <Badge>Zotero connection placeholder</Badge>
